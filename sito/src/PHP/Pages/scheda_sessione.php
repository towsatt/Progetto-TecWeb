<?php
    ...
    $titolo = 'Scheda Sessione';
    $descrizione = 'Visualizza la scheda della sessione della tua campagna';
    $keywords = 'sessione, campagna, scheda, visualizza';

    $header = headerPlaceholder($titolo, $descrizione, $keywords, "scheda_sessione");
    $page = file_get_contents(BASE_PATH . "/src/HTML/structure/scheda_sessione.html");
